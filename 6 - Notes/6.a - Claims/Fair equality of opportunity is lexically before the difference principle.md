...
---
## Summary
The idea that fair equality of opportunity has to be fully satisfied before any consideration of the difference principle.
## Significance
This is important in understanding the way that the second principle of justice is to be implemented.
## Explanation
...
3. A serial ordering allows for inequalities in the socio-economic sphere to generate overall benefits while ensuring that individuals have sufficient primary goods.
	- This relates to the idea of self-respect. It is impossible to secure self-respect through material means, since they are zero-sum, but equal basic liberties can indeed be secured for all. Grounding self-respect in this means that all can enjoy self-respect, and given this, people in the original position would never accept less than equal basic liberties since it would mean undermining the most important primary good, that of self-respect.
## References
- [[Fair equality of opportunity is a precondition for pure procedural justice]]
	- This then means that pure procedural justice is lexically before the difference principle.
- [[Social and economic inequalities are to satisfy the Difference Principle and Fair Equality of Opportunity]]
	- Puts this in a larger context.